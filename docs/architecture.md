...
Before snapshot or control traffic, a host must advertise bridge API `1`, terminal protocol `17`,
Herdr `0.7.5` or newer, and the required web compatibility/feature surface. Unsupported or malformed
